...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // `render` below is a hoisted function declaration, so TypeScript cannot
    // prove the two guards above ran before it. These aliases carry the
    // narrowed (non-null) types into that closure. Behaviour is unchanged.
